...
class Find2Adapter(context: Context) : RecyclerView.Adapter<Find2Adapter.Find2ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): Find2Adapter.Find2ViewHolder = Find2ViewHolder(parent)

    override fun getItemCount(): Int = if (list == null) 0 else list!!.size

    override fun onBindViewHolder(holder: Find2ViewHolder, position: Int) {
...
//                   println("초대하기")
    ...
    inner class Find2ViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
